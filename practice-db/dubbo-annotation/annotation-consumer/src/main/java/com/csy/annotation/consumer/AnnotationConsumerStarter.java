 ...
 */
package com.csy.annotation.consumer;

import com.basic.use.BasicInfo;
import com.basic.use.DemoService;
import com.csy.annotation.consumer.comp.DemoServiceComponent;
...
public class AnnotationConsumerStarter {
    ...
    @Configuration
    @EnableDubbo(scanBasePackages = "com.csy.annotation.consumer.comp")
    @PropertySource("classpath:/spring/dubbo-consumer.properties")
    @ComponentScan(value = {"com.csy.annotation.consumer.comp"})
