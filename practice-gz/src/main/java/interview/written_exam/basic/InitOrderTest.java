...
import interview.written_exam.basic.init_ext.Child;
import interview.written_exam.basic.init_ext.InitB;
...
public class InitOrderTest { //@MsY-Done
    ...
    public void test_static_block() throws Exception { //Done
        ...
        Class clazz = classLoader.loadClass("interview.written_exam.basic.init_ext.InitA");
        clazz.forName("interview.written_exam.basic.init_ext.InitA");
