 ...
 * @date 2023/6/7
 */
public class CharEncodeTest { //@MsY-Doing
     ...
     *
     * 关联点学习：
     * 1）JVM代码中Unicode具体实现：解释"在Java中字符只以一种形式存在，那就是Unicode"（Doing）
     *
     * 问题点答疑：
     * 1）Unicode字符集与UTF-8、GB2312等字符集有何不同？
     * 2）什么是编码、解码？是在什么时候进行转换的？
     *
