...
public class MainTest {
     ...
     */
    private static final String APPID = "test_22222";

    /**
     * Hutool工具使用
     * https://hutool.cn/docs/#/
     */
    private static final String ADDRESS = "https://oa.teddylaboratory333.com";

    public static void main(String[] args) {
        testRegist(ADDRESS);
        testGetoken(ADDRESS);
//        testCreateFlow(ADDRESS,"/api/workflow/paService/doCreateRequest", null);
        getCreateFlow(ADDRESS, "/api/workflow/paService/getWorkflowRequest",buildGetFlowParam());
    }
    ...
    public static Map<String,Object> testRegist(String address){
        ...
        System.out.println("注册_许可证_请求的数据：" + SYSTEM_CACHE);
        ...
        // 打印ECOLOGY响应信息
        System.out.println("注册_许可证_响应的数据："+data);
    ...
    public static Map<String,Object> testGetoken(String address){
        ...
        System.out.println("创建_token_请求的数据：" + SYSTEM_CACHE);
        //调用ECOLOGY系统接口进行注册
        ...
        System.out.println("创建_token_响应的数据：" + data);
        Map<String,Object> datas = JSONUtil.parseObj(data);
    ...
    public static Map<String, Object> buildGetFlowParam() {
        Map<String, Object> map = new HashMap<>();
        map.put("requestId", "92742");
        return map;
    }
     ...
     */
    public static String testCreateFlow(String address, String api, Map<String, String> bodyParam){
...
//        System.out.println("创建_审核流程_请求的数据：" + jsonParams);
//        调用ECOLOGY系统接口
        Map<String, Object> params = new HashMap<>();
        params.put("mainData", "[{'fieldName':'xxx','fieldValue':'xxx'}]");
        params.put("requestName", "测试流程111");
        params.put("workflowId", "69");

        String data = HttpRequest.post(address + api)
                .header("appid", "test")
                .header("token",token)
                .header("userid",encryptUserid) //此参数必须有，目前测试且需要为1
                .form(params)
                .execute().body();

        System.out.println("创建_审批流程_响应的数据：" + data);


       return data;
    }

    public static String getCreateFlow(String address, String api, Map<String, Object> bodyParam){
        ...
        RSA rsa = new RSA(null,spk);
        //对用户信息进行加密传输,暂仅支持传输OA用户ID
        String encryptUserid = rsa.encryptBase64("994",CharsetUtil.CHARSET_UTF_8,KeyType.PublicKey);

        System.out.println("获取_审批流程_请求的数据：" + bodyParam);
        ...
        System.out.println("获取_审批流程_响应的数据：" + data);
        return data;
    }
}
