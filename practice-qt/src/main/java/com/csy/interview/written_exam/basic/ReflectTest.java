...
import com.csy.interview.written_exam.basic.reflect_ext.A;
import com.csy.interview.written_exam.basic.reflect_ext.OnlyReadClass;
...
public class ReflectTest { //@MsY-Doing
    ...
    public void test_get_class_by_forName() { //Done
        Class<?> c = null;
        try {
            c = Class.forName("com.csy.interview.written_exam.basic.reflect_ext.A");
        } catch (Exception e) {
            e.printStackTrace();
        }
        System.out.println("className：" + c.getName());
