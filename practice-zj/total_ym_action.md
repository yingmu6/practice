...
| 036 | 注解以及高级特性使用                 | 熟悉注解           | P1   | 0%   | 2023-06-02 |            |
| 037 | Java8的Stream使用             | 熟悉Stream       | P2   | 0%   | 2023-06-03 |            |
| 038 | Java8的Optional使用           | 熟悉Optional     | P2   | 0%   | 2023-06-04 |            |
...
| 序号  | 实践点     | 实践目标      | 优先级 | 当前进度 | 创建时间       | 结束时间 |
|-----|---------|-----------|-----|------|------------|------|
| 001 | 字符编码&累加 | 熟悉字符编码&累加 | P1  | 60%  | 2023-04-28 |      |
| 001 | 类型转换    | 熟悉类型转换    | P1  | 6%   | 2023-06-07 |      |
