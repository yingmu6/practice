package thinking.concurrent;//: concurrency/FastSimulation.java
import java.util.concurrent.*;
import java.util.concurrent.atomic.*;
import java.util.*;
import static net.mindview.util.Print.*;

public class FastSimulation { //@TkY-Doing
  ...
  public static void main(String[] args) throws Exception { //Doing
     ...
     * 输出结果：
     * ......
     * Old value changed from 433
     * Old value changed from 436
     * Old value changed from 455
     * Old value changed from 405
     * ......
     *
     * 结果分析：
     * 1）
